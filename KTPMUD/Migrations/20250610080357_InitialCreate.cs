    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ThanhToanVienPhis", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ThanhToanVienPhis_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LichHens_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LichHens_BacSis_IdBacSi",
                        column: x => x.IdBacSi,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ThanhToanVienPhis_UserId",
                table: "ThanhToanVienPhis",
                column: "UserId");
        }
